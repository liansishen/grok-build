...
pub fn export_copy_tip() -> EphemeralTip {
    ...
    EphemeralTip {
        ...
        ..EphemeralTip::new(
            EXPORT_COPY_TIP_KEY,
            Line::from(vec![
                Span::styled(xai_grok_i18n::t("tips.export_copy.prefix"), dim),
                Span::styled("/copy", key_style),
                Span::styled(xai_grok_i18n::t("tips.export_copy.mid"), dim),
                Span::styled("/export", key_style),
                Span::styled(xai_grok_i18n::t("tips.export_copy.suffix"), dim),
            ]),
        )
