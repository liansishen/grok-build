...
impl WelcomeWorkspaceMode {
    ...
    pub fn label(self) -> &'static str {
        match self {
            Self::Sandbox => xai_grok_i18n::t("welcome.workspace.sandbox"),
            Self::LocalWorkspace => xai_grok_i18n::t("welcome.workspace.local"),
        }
    }

    pub fn hint(self) -> &'static str {
        match self {
            Self::Sandbox => xai_grok_i18n::t("welcome.workspace.help.sandbox"),
            Self::LocalWorkspace => xai_grok_i18n::t("welcome.workspace.help.local"),
        }
    }
    ...
    pub fn status_label(self, cli_locked: bool) -> &'static str {
        match (self, cli_locked) {
            (Self::Sandbox, _) => xai_grok_i18n::t("welcome.workspace.sandbox"),
            (Self::LocalWorkspace, true) => xai_grok_i18n::t("welcome.workspace.local_cli"),
            (Self::LocalWorkspace, false) => xai_grok_i18n::t("welcome.workspace.local_short"),
        }
    }
...
pub fn render_workspace_mode_picker(
    ...
    let workspace_label = format!("{}  ", xai_grok_i18n::t("welcome.workspace.label"));
    let workspace_label_w = UnicodeWidthStr::width(workspace_label.as_str()) as u16;
    buf.set_span(
        row.x,
        row.y,
        &Span::styled(workspace_label.as_str(), label_style),
        workspace_label_w,
    );

    let mut x = row.x.saturating_add(workspace_label_w);
    ...
    let trailing = if ack_pending {
        format!("  {}", xai_grok_i18n::t("welcome.workspace.confirm_local"))
    } else if startup_locked {
        format!("  {}", xai_grok_i18n::t("welcome.workspace.locked_by_cli"))
    } else {
        format!("  {}", xai_grok_i18n::t("welcome.workspace.cycle_hint"))
    };
