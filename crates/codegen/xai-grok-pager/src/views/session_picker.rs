...
impl SourceFilter {
    pub fn label(self) -> &'static str {
        match self {
            Self::Grok => xai_grok_i18n::t("session_picker.filter.grok"),
            Self::Headless => xai_grok_i18n::t("session_picker.filter.headless"),
...
pub(crate) fn build_content_header_label(
    ...
    if content_loading {
        ...
        xai_grok_i18n::t_fmt(
            ...
            &[("spinner", spinner_frames.get(frame_idx).copied().unwrap_or(""))],
        )
