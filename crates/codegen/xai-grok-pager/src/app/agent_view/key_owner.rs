...
impl EscStep {
    pub(crate) fn label(self) -> &'static str {
        match self {
            ...
            Self::ParkFocus => xai_grok_i18n::t("hint.scrollback"),
            Self::KeepRunning => xai_grok_i18n::t("modal.continue_to_run"),
            Self::DismissElicitWaiting => xai_grok_i18n::t("hint.close"),
        }
    }
}
