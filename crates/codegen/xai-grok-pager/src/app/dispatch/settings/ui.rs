...
use super::setters::{
    ...
    set_fork_secondary_model_inner, set_fork_secondary_reasoning_effort_inner,
    ...
    set_timestamps_inner, set_ui_language_inner, set_usage_refresh_interval_minutes_inner,
...
pub(in crate::app::dispatch) fn action_for_reset(
    ...
    match (key, value) {
        ...
        ("usage_refresh_interval_minutes", SettingValue::Int(i)) => {
            Some(Action::SetUsageRefreshIntervalMinutes(*i))
        }
...
pub(in crate::app::dispatch) fn apply_setting_rollback(
    ...
    match (key, rollback_value) {
        ...
        ("usage_refresh_interval_minutes", SettingValue::Int(i)) => {
            set_usage_refresh_interval_minutes_inner(app, *i)
        }
