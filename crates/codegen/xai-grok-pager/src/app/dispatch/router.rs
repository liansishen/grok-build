...
use super::settings::setters::{
    ...
    clear_web_search_model, preview_auto_dark_theme, preview_auto_light_theme, preview_theme,
    ...
    set_scroll_lines, set_scroll_mode, set_scroll_speed, set_show_request_metrics,
    set_show_session_usage_bar, set_show_thinking_blocks, set_show_tips, set_simple_mode,
    set_theme, set_timeline, set_timestamps, set_ui_language, set_usage_refresh_interval_minutes,
...
pub(crate) fn dispatch(action: Action, app: &mut AppView) -> Vec<Effect> {
    ...
    let effects = match action {
        ...
        Action::SetShowSessionUsageBar(v) => set_show_session_usage_bar(app, v),
        Action::SetShowRequestMetrics(v) => set_show_request_metrics(app, v),
