...
use super::settings::setters::{
    clear_default_model, clear_fork_secondary_model, clear_fork_secondary_reasoning_effort,
    clear_subagent_model_inheritance, clear_web_search_model, preview_auto_dark_theme,
    ...
    set_follow_up_behavior, set_fork_secondary_model, set_fork_secondary_reasoning_effort,
    ...
    set_scroll_lines, set_scroll_mode, set_scroll_speed,
    set_show_background_task_completion_reminders, set_show_shortcuts_bar, set_show_thinking_blocks,
    set_show_tips, set_simple_mode, set_subagent_model_inheritance, set_theme, set_timeline,
    set_timestamps, set_transparent_bg, set_ui_language, set_usage_refresh_interval_minutes,
...
fn dispatch_inner(action: Action, app: &mut AppView) -> Vec<Effect> {
    ...
    let effects = match action {
        ...
        Action::SetShowShortcutsBar(v) => set_show_shortcuts_bar(app, v),
        ...
        Action::SetTransparentBg(v) => set_transparent_bg(app, v),
        ...
        Action::SetUiLanguage(s) => set_ui_language(app, s),
        ...
        Action::SetWebSearchModel(v) => set_web_search_model(app, v),
        Action::ClearWebSearchModel => clear_web_search_model(app),
        ...
        Action::SetForkSecondaryReasoningEffort(v) => set_fork_secondary_reasoning_effort(app, v),
        Action::ClearForkSecondaryReasoningEffort => clear_fork_secondary_reasoning_effort(app),
