...
pub(crate) fn attachment_message() -> &'static str {
    xai_grok_i18n::t("toast.prompt_editor.attachments")
}
pub(crate) fn voice_message() -> &'static str {
    xai_grok_i18n::t("toast.prompt_editor.voice")
}
pub(crate) fn paste_message() -> &'static str {
    xai_grok_i18n::t("toast.prompt_editor.paste")
}
pub(crate) fn ownership_message() -> &'static str {
    xai_grok_i18n::t("toast.prompt_editor.ownership")
}
fn prompt_editor_prepare_failure() -> &'static str {
    xai_grok_i18n::t("toast.prompt_editor.prepare_failed")
}
fn prompt_editor_failure() -> &'static str {
    xai_grok_i18n::t("toast.prompt_editor.failed")
}
fn prompt_editor_nonzero() -> &'static str {
    xai_grok_i18n::t("toast.prompt_editor.nonzero_exit")
}
fn prompt_editor_invalid_utf8() -> &'static str {
    xai_grok_i18n::t("toast.prompt_editor.invalid_utf8")
}
fn prompt_editor_too_large() -> &'static str {
    xai_grok_i18n::t("toast.prompt_editor.too_large")
}
fn prompt_editor_stale() -> &'static str {
    xai_grok_i18n::t("toast.prompt_editor.stale")
}
