...
impl AgentCommand {
    ...
    pub fn display_name(&self) -> &'static str {
        match self {
            ...
            Self::SwitchModelCompact => xai_grok_i18n::t("agent.command.switching_model"),
            ...
            Self::MemoryFlush => xai_grok_i18n::t("agent.command.flushing_memory"),
            Self::MemoryDream => xai_grok_i18n::t("agent.command.consolidating_memory"),
        }
    }
