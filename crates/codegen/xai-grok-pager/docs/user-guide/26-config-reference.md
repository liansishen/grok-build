...
| `ui.show_background_task_completion_reminders` | `boolean` | `yes` | `user` | Show the model a system reminder after an AI-started background task completes. Restart required. |
