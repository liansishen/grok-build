        ...
        while let Some(cmd) = rx.recv().await {
            match cmd {
                ...
                PermissionCommand::Request {
                    ...
                    let rejected = || Decision::Reject(xai_grok_i18n::t("permission.reason.user_rejected").to_owned());
...
mod tests {
    ...
    async fn decide(
        ...
        handle
            .request(access, tool_call_update, None, None, None)
            .await
    }
    ...
    mod hook_ask {
        ...
        async fn request_with_ask(
            ...
            tokio::time::timeout(
                std::time::Duration::from_secs(5),
                mgr.request_permission(PermissionRequest {
                    hook_ask: Some(ask()),
