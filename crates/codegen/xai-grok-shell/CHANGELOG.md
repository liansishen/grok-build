...
- 已更新英文与简体中文的回合跳转标签、说明及重做快捷键帮助，与上游的新行为一致。
...
- 编译与测试仅通过 GitHub Actions：Linux x86_64 执行 sampler 库测试，Linux x86_64 与 Windows x86_64 执行 release 构建、二进制版本校验和产物上传；发布任务生成 SHA256 校验和。
