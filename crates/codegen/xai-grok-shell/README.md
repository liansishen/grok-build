...
To generate the compact summary with a cheaper or faster model from the same provider, set `[model.<id>] compaction_model`. Blank or unset uses the session model.
